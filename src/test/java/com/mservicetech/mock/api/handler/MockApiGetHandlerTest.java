...
public class MockApiGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MockApiGetHandlerTest.class);
    ...
    @Test
    public void testMockApiGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/mock/api?path=%2Fmesh%2Fcore&method=GET";
